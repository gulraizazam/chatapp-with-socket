...
class MessageController extends Controller
{
    public function conversation($userId) {
        ...
        $messages = Message::join('user_messages','messages.id','=','user_messages.message_id')->join('users','users.id','=','user_messages.sender_id')->where('user_messages.sender_id',$userId)->where('user_messages.receiver_id',Auth::user()->id)->get();
        //dd($messages);
